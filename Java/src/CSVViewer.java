...
public class CSVViewer extends JFrame {
 ...
 public CSVViewer() {
    ...
    private String[][] fetchData() {
        ...
        String params = "spatial-resolution=low&temporal-resolution=monthly&group-by=gearType&datasets[0]=public-global-fishing-effort:latest&date-range=2024-01-01,2024-05-01&format=csv";
